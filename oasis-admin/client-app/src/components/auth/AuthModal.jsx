...
export const AuthModal = () => {
  ...
  const [profileForm, setProfileForm] = useState({ photo: '', bio: '' });
  ...
  const handleLogin = (e, provider) => {
    ...
    // Move to next step (Profile Customization) instead of instant closing
    setStep(2);
  };
      ...
      <div className="fixed inset-0 z-[200] flex items-center justify-center px-4 bg-black/60 backdrop-blur-sm">
        ...
        >
          ...
          <div className="bg-spa-green/20 p-6 flex justify-between items-center border-b border-spa-seafoam/20">
            ...
            <button onClick={() => setIsOpen(false)} className="text-white hover:text-spa-hibiscus text-2xl font-bold">
              &times;
            </button>
          </div>
